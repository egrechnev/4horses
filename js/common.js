document.addEventListener('DOMContentLoaded', function() {
	...
	/*smooth scrolling of the anchor*/
	...
	let slider = document.querySelector('.participants-container'),
		slides = slider.querySelectorAll('.participants .slide'),
		prevArrow = document.querySelector('.participants .prev'),
		nextArrow = document.querySelector('.participants .next'),
		counter = document.querySelector('.participants .slider-counter'),
		slideIndex = 1;
